...
NSNotificationName const ApptentiveCustomNotificationCenterPayload = @"ApptentiveCustomNotificationCenterPayload";  
...
NSString *const ApptentiveCustomNotificationCenterScheme = @"apptentive-broadcast";
